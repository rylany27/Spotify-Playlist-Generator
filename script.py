...
class UserClient:
    def __init__(self, sp_dc=None, sp_key=None):
        self.sp_dc = os.getenv("SP_DC_5") if sp_dc is None else sp_dc
        self.sp_key = os.getenv("SP_KEY_5") if sp_key is None else sp_key
...
if __name__ == "__main__":
    ...
    num_users = int(sys.argv[4]) if len(sys.argv) > 4 and sys.argv[4].isdigit() else 7
